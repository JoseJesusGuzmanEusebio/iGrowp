<?php
	if(isset($_POST['interes'])){
		...
		$emailUsuario= utf8_decode($_POST['id']);
		...
		$query = 'call consulta_content_user ("'.$emailUsuario.'", "'.$interes.'");';
		...
		if(mysqli_num_rows($result) <= 0) {
			if(isset($_POST["idUsuario"])){	
				if($emailUsuario==$_COOKIE[$cookie_name]){
				echo '<br><br>No tienes contenidos disponibles para "'.utf8_encode($interes).'".
					...
					echo '<br><br>Este usuario no tiene contenidos disponibles para "'.utf8_encode($interes).'".
					<br><br><br><br><br><br><br>
					<br><br><br><br><br><br>
					<br><br><br><br><br><br><br><br><br>
					<br><br><br><br><br><br><br><br><br>
