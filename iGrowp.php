...
<head>
	...
	<script language="javascript">
		function enviarForm(){
			if(validarNombre && longitudMinima(document.getElementById("txtNombre").value)){
		...
		function validarNombre(){
			//Creamos un objeto 
			var object=document.getElementById(txtNombre);
			var valueForm=object.value;
...
<body>	
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<form class="navbar-form navbar-right" role="search" id="login" method="POST" onsubmit="" action="Login.php">
				<div id="divCorreoLogin" class="form-group">
					<input type="text" id="txtUsuario" name="txtUsuario" class="form-control" placeholder="Correo electrónico" required>
					<span id="iconoCorreoLogin" class=""></span>
				</div>
				...
				<div class="container">
					<form id="registro" method="POST" onsubmit="return enviarForm()" action="FrameFormularioRegistro.php">
						<div id="divNombre" class="form-group">	
							<input type="text" id="txtNombre" name="txtNombre" class="form-control" placeholder="Nombre completo" required onkeypress="return soloLetras(event)" onchange="espaciosInnecesarios(this.value)" maxlength="100" >
							<span id="iconoNombre" class=""></span>
						</div>
						...
						<div id="divContra" class="form-group">
							...
							<span id="iconoContra" class=""></span>
						</div>
						<div id="divConf" class="form-group">
